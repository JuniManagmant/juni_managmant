...
CREATE TABLE `teacher_course` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `teacher_course_ID_uindex` (`ID`),
  KEY `teacher_course_courses_ID_fk` (`course_id`),
  KEY `teacher_course_teacher_ID_fk` (`teacher_id`),
  CONSTRAINT `teacher_course_courses_ID_fk` FOREIGN KEY (`course_id`) REFERENCES `courses` (`ID`),
...
-- Dump completed on 2022-06-12 13:28:16
