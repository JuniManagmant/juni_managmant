...
public class studentPages {
	...
	public static void mainPage(JFrame mainFrame){
		JLabel mainLabel = new JLabel("سامانه جونی منیجمنت");

		mainLabel.setBounds(500,500,200,40);
    ...
    public static  void test(JFrame mainFrame) {
        JButton testButton = new JButton("OK");
        JLabel testLabel = new JLabel("not clicked");
        ...
        testButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                eshteghal(mainFrame,"امیرمحمد");
            }
        });

        testButton.setBounds(500,500,130,40);
        testLabel.setBounds(500,300,200,30);
